...
import type { AlloyDesktopMarker, SavedServer } from "../../shared/ipc"

export type DesktopSavedServer = SavedServer
...
export function alloyDesktop(): AlloyDesktopMarker | null {
  return (
    (globalThis as { alloyDesktop?: AlloyDesktopMarker }).alloyDesktop ?? null
  )
}
