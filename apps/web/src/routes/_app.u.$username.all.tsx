...
/**
 * `/u/$username/all` — all clips with sort + game filter, driven entirely
 * by search params so the filtered view is shareable / back-navigable.
 *
 *   ?sort=recent | oldest | top | views   (default: recent)
 *   ?game=<slug>                          (slug from `gameRef`; omitted = no filter)
 */
...
export const Route = createFileRoute("/_app/u/$username/all")({
