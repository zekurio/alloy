...
export interface InitiateClipInput {
  ...
  sizeBytes: number
  /** Optional pre-rendered JPEG scrubber sprite generated by Alloy Desktop. */
  scrubberSizeBytes?: number
  title: string
  description?: string
...
export interface InitiateClipResponse {
  clipId: string
  ticket: UploadTicket
  /** Present only when the client requested an optional scrubber upload. */
  scrubberTicket?: UploadTicket
}
