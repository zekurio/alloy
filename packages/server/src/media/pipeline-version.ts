 ...
 * naming, playlist format, container layout, and ladder semantics. Stored on
 * the clip row at commit; the startup rendition backfill re-encodes any ready
 * clip whose stored fingerprint differs from this value.
 *
