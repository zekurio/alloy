...
const SNOWCODE =
  "660866676659555353000359017052595401705652525670000002017056616003045755015954540166686621666757"
const V4_SNOWCODE =
...
test("Discord activity IDs use FxEmbed's numeric snowcode format", () => {
  ...
  assert.equal(decodeDiscordActivityId(V4_SNOWCODE), CLIP_ID)
