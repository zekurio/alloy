  ...
  return (
    <AppHeader>
      <AppHeaderBrand
        ...
        renderLogo={(logo) => (
          // The logo is an inline-flex span; inside a block anchor it sits on
          // a text baseline that reserves descender space below the mark. A
          // flex anchor has no line box, so the logo centers cleanly.
          <Link
            to="/"
            aria-label={t("Home")}
