      ...
      {games.length > 0 ? (
        <div className="divide-border divide-y">
          {games.map((game) => (
            ...
            >
              <span className="bg-surface-raised text-foreground-muted border-border grid size-8 shrink-0 place-items-center rounded-md border">
        ...
        <div className="text-foreground-dim flex min-h-12 items-center gap-2 py-2 text-xs">
          <span className="bg-surface-raised border-border grid size-8 shrink-0 place-items-center rounded-md border">
            {fallbackIcon}
          </span>
          {emptyText}
        </div>
