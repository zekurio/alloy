export const DE_MESSAGES: Record<string, string> = {
  ...
  "Clips from this user will show up here once they upload.":
    "Clips von dieser Person erscheinen hier, sobald sie etwas hochlädt.",
  ...
  "Switch stable or nightly desktop releases.":
    "Wechsle zwischen stabilen und Nightly-Desktop-Releases.",
  System: "System",
  ...
  "They'll be signed out and their clips hidden. Their data is kept and you can enable them again later.":
    "Die Person wird abgemeldet und ihre Clips ausgeblendet. Die Daten bleiben erhalten und du kannst sie später wieder aktivieren.",
